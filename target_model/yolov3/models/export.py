...
if __name__ == '__main__':
    ...
    try:
        ...
        torch.onnx.export(model, img, f, verbose=False, opset_version=12, input_names=['images_5000'],
                          output_names=['classes', 'boxes'] if y is None else ['output'],
                          dynamic_axes={'images_5000': {0: 'batch', 2: 'height', 3: 'width'},  # size(1,3,640,640)
