...
def ap_per_class(tp, conf, pred_cls, target_cls, plot=True, save_dir='.', OUT_DIR = ".", names=(), eps=1e-16, tag = True):
    ...
    if plot:
        ...
        if tag:
            plot_pr_curve(px, py, ap, 'data/output_new_100/simba_flir_2/PR_ori_curve.png', names)
        else:
            plot_pr_curve(px, py, ap, 'data/output_new_100/simba_flir_2/PR_adv_curve.png', names)
